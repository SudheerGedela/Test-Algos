...
//        Integer[] actualArray;
//
//        actualArray = SortUtils.getRandomUnSortedArray(10, 10);
//        //Bubble
//        System.out.println("**************************************************");
...
//        };
//
//        SortUtils.sortAndLogTime(bubbleSortInter, actualArray);
//
//        //Merge
//        System.out.println("**************************************************");
//        System.out.println("Merge Sort");
//        pracSorts.origArray = SortUtils.getRandomUnSortedArray(100, 100);
//        SortUtils.sortAndLogTime(new MergeSort(), pracSorts.origArray);
//
//
//        //Quick
//        System.out.println("**************************************************");
...
//        pracSorts.origArray = SortUtils.getRandomUnSortedArray(10000000, 10000000);
////        pracSorts.sortAndLogTime(new QuickSort(), arr);
//        SortUtils.sortAndLogTime(new QuickSort(), pracSorts.origArray);
//
//
//    }
//
